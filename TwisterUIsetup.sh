...
sudo pacman -S git libreoffice-fresh mousepad android-tools file-roller gimp plank mpg123 tk python-pillow python-pip mpv neofetch audacious meson gtk3 cairo vala meson gnome-menus libgee libblockdev gnome-calendar gnome-contacts gparted gnome-maps hardinfo parole ristretto samba vlc xterm python-setuptools python-wheel flameshot noto-fonts yay yad appmenu-gtk-module 
...
sudo rm -f /usr/share/applications/org.gnome.Evolution.desktop
...
sudo find /usr/share/fonts/opentype -type d -exec chmod 755 {} \;
sudo find /usr/share/fonts/opentype -type f -exec chmod 644 {} \;
sudo find /usr/share/fonts/truetype -type d -exec chmod 755 {} \;
sudo find /usr/share/fonts/truetype -type f -exec chmod 644 {} \;
sudo chown -R root:root /usr/share/fonts/opentype
...
sudo find /usr/lib/xfce4/panel -type f -exec chmod 755 {} \;
...
echo "[Desktop Entry]
Name=Twister UI Manjaro Patcher
Comment=Updates Twister UI Manjaro
...
sudo cp /opt/discord/discord.desktop ~/Desktop
